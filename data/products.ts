export const products = [
  {
    title: "Aceternity UI",
    description:
      "Build modern websites 10x faster with amazing UI components and templates.",
  ...
  },
  {
    ...
    logo: "/products/sprintsocial.svg",
  },
  {
    title: "Intent JS",
    description:
      "A fresh take on traditional nodejs frameworks, change the way you engineer your products.",
  ...
  },
  {
    title: "GetaResume",
    description:
      "A resume to portfolio website generator that can generate your online portfolio website within seconds.",
  ...
  },
  {
    ...
    description:
      "Tailored growth plans, career paths, and a standout professional profile.",
  ...
  },
  {
    title: "Metamorix UI",
    description:
      "Kickstart your next side project with free and premium Tailwind & Framer Motion UI blocks.",
